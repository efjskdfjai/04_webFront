...
console.log('JS는 홀따옴표로 문자열로 취급');

// ------------------------------------------------------

// 변수의 선언
// 메모리에 값을 저장할 공가늘 만들고 이름을 붙이는 것
// 작성법
// 변수종류 변수명;
var number1;
...
number2 = 400; // number2에 400 재대입(기존 20값에 덮어쓰기)
...
// PI = 1.23;
// 02_변수와자료형.js:83 Uncaught TypeError: Assignment to constant variable
// 상수로 배정되어 있다
// -> 사수에 새로운 값을 대입할 수 없는데
// 재대입을 하고있어 오류가 발생함
...
// 즉, 코드 브록 내부에서 선언한 변수(let const)는
...
// console.log(num1); 02_변수와자료형.js:109 Uncaught ReferenceError: num1 is not defined
// console.log(num2); 02_변수와자료형.js:109 Uncaught ReferenceError: num1 is not defined
...
// javascript에서의 배열은 값 추가 및 삭제 기능
...
const user = {id: "user01", pw: "passo1", userName: "홍길동"};
console.log(user);
