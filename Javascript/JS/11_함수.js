...
arrowList[0].addEventListener("click", () => {
  SpeechRecognitionAlternative("화살표 점수 기본 형태 연습")
});
...
arrowList[1].addEventListener("click", (e) => {
  ...
  e.target.style.backgroundColok = "pink";
...
arrowList[3].addEventListener("click", () => {
  ...
  // JS 객체 object 타입 ! => return 한 줄이어도 생략 불가
});
