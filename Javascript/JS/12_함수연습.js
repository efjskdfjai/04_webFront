...
function fn2() {
  ...
  console.log("2번 : " + parseInt(num) + parseInt(num2));
}
...
function fn3() {
  ...
  console.log("3번 : " + parseInt(str) * parseInt(str2));
}

fn3();

// 4. 두 개의 숫자를 매개변수로 받아, 첫 번째 숫자가 
// 두 번째 숫자보다 크면 "첫 번째 숫자가 더 큽니다"를 출력하고,
// 그렇지 않으면 "두 번째 숫자가 더 크거나 같습니다"를 출력하는 함수를 
// 선언 및 정의하고 호출하시오
function fn4(num, num2) {
